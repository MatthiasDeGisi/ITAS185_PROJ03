...
class Motorcycle(v.Vehicle):
    ...
    def __repr__(self) -> str:
        """Return a string representation of the motorcycle and its attributes.
    ...
    def __str__(self) -> str:
        """Return a nicely formatted string with motorcycle
        info (Type, model, colour, speed, position).
